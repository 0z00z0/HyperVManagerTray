...
| [ZeroZero.Win32](https://github.com/0z00z0/0z0-shared) | 0.9.0 | The count of this app's own short-lived windows, asked by the dashboard before it hides itself on lost focus so the update window does not close it |
